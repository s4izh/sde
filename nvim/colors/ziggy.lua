-- https://github.com/jenav/dotfiles/blob/main/.config/nvim/colors/ziggy.vim

-- Check Neovim version and show a warning if the version is below 0.9
if vim.fn.has('nvim') == 1 and vim.fn.has('nvim-0.9') == 0 then
    vim.api.nvim_echo({
...
M.style = function()
	...
	highlight(0, "MiniTablineModifiedCurrent", { link = "ZiggyYellowLineActive" })
	...
	highlight(0, "MasonHighlightBlockBoldSecondary", { link = "ZiggyDarkCyanMode" })
